...
$poker.textContent = 'กดที่นี่เพื่อสุ่มการ์ด'
...
setTimeout(function () {
  printMessage('กดสุ่มการ์ดเพื่อรับความรู้เกี่ยวกับคอมพิวเตอร์')
}, randomDelay)

setTimeout(function () {
  printMessage('และนำความรู้ไปใช้ในการเล่นเกม')
}, randomDelay + 5000)

setTimeout(function () {
  printMessage('ขอให้สนุก;)')
}, randomDelay + 10000)
